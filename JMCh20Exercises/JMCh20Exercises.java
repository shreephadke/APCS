...
public class JMCh20Exercises<E>
{
    ...
    public ListNode<E> removeFirst( ListNode<E> head )
    {
        if ( head != null )
        {
            ListNode<E> newNode = head.getNext();
            head.setNext( null );
            return newNode;
        }
    ...
    {
        ListNode<E> head2 = null;
        ListNode<E> node = head;

        while ( node != null )
        {
            ListNode<E> node2 = new ListNode<E>( node.getValue(), head2 );
            head2 = node2;
            node = node.getNext();
        }
    ...
    public ListNode<E> rotate( ListNode<E> head )
    {
        ...
        ListNode<E> head2 = head.getNext();
        ListNode<E> tempNode = head2;
    ...
    {
        ListNode<String> strNode = head;
        ListNode<String> bef = null;
        while ( strNode != null && s.compareTo( (String)strNode.getValue() ) > 0 )
        {
            bef = strNode;
            strNode = strNode.getNext();
        }

        if ( strNode != null && s == ( strNode.getValue() ) )
        {
            return head;
        }

        ListNode<String> newNode = new ListNode<String>( s, strNode );
    ...
    {
        ListNode<E> node = head;
        ListNode<E> nodeCopy = head;

        while ( nodeCopy != null && nodeCopy.getNext() != null )
        {
            node = node.getNext();
            nodeCopy = nodeCopy.getNext().getNext();
        }
    ...
    public static void sort( ListNode<String> head )
    {
        while ( head != null )
        {
            ...
            while ( next != null )
            {
                ...
                if ( val.compareTo( headCopy.getValue() ) < 0 )
                {
                    headCopy = next;
                }
                next = next.getNext();
            }
            String bef = headCopy.getValue();
            headCopy.setValue( head.getValue() );
            head.setValue( bef );
            head = head.getNext();
        }
    ...
    public static ListNode2<Integer> removeMax( ListNode2<Integer> head )
    {
        ...
        ListNode2<Integer> modHead = head;
        ListNode2<Integer> largest = new ListNode2<Integer>( Integer.MIN_VALUE, null, null );

        while ( head != null )
        {
            if ( head.getValue().compareTo( largest.getValue() ) > 0 )
            {
                largest = head;
            }
            head = head.getNext();
        ...
        ListNode2<Integer> aft = largest.getNext();
        ListNode2<Integer> bef = largest.getPrevious();

        aft.setPrevious( bef );
        bef.setNext( aft );

        largest.setNext( null );
        largest.setPrevious( null );

        if ( modHead.getValue() == largest.getValue() )
        {
            return bef;
        }
    ...
    public static void main( String[] args )
    {
        ...
        do
        {
            ...
            System.out
                .println( "   (C) 20-11 moveToBack( ListNode<String> head, String pattern )" );
            ...
            if ( response.length() > 0 )
            {
                ...
                switch ( response.charAt( 0 ) )
                {
                    ...
                    case 'D':
                    case 'd':
                        ListNode<String> headD = buildList( new String[] { "Santa", "bunny", "newt",
